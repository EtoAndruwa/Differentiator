 ...
 * 
 * @param file_name The name of the ouput html file
 * @return Returns the error code  
 */
 ...
 * 
 * @param file_name The pointer to the text with the name of the html file
 * @return Returns the error code 
 */
int html_start(char* file_name); 
/*####################################################################################################################################################################*/
 ...
 * 
 * @param dir_file_name The name of the file that must be created using dot 
 * @return Returns the error code  
 */
 ...
 * 
 * @param dir_file_name The combined file name (html file)
 * @return Returns the error code 
 */
 ...
 * @param dir_file_name The combined file name
 * @return Returns the error code 
 */
